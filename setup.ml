...
(* OASIS_START *)
(* DO NOT EDIT (digest: c1dcbf79be540fee2decacbbde8578ba) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
              ...
              (OASISLicense.DEP5Unit
                 {
                    ...
                    excption = None;
                    version = OASISLicense.Version "3"
                 });
          license_file = None;
          copyrights = [];
          maintainers = [];
          authors = ["tacigar"];
          homepage = None;
          synopsis = "JSON Parser written in OCaml.";
          description = None;
          categories = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("menhirLib", None)];
                      bs_build_tools =
                        [ExternalTool "menhir"; ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\174;i\1525\171\231\195eB\246&\024\156\253\216";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
